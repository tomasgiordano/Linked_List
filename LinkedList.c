...
static int addNode(LinkedList* this, int nodeIndex,void* pElement)
{
    ...
    if(this!=NULL&&nodeIndex>=0&&nodeIndex<=ll_len(this))
    {
        ...
        {
            Node* pNodeAux= test_getNode(this,nodeIndex-1);

            if(pNodeAux!=NULL)
            {
                pNew->pNextNode= pNodeAux->pNextNode;
                pNodeAux->pNextNode=pNew;
                this->size++;
                returnAux=0;
            }
        }
...
void* ll_get(LinkedList* this, int index)
{
    ...
    {
        Node* pNodeAux=getNode(this,index);
...
int ll_remove(LinkedList* this,int index)
{
    ...
    if(this!=NULL&&index<ll_len(this)&&index>=0)
    {
        ...
        if(pNodeAuxiliar!=NULL)
        {
            if(index==0)
            {
                this->pFirstNode=pNodeAuxiliar->pNextNode;
                free(pNodeAuxiliar);
                this->size--;
                returnAux=0;
            }
            ...
            {
                Node* pPreNode=getNode(this,index-1);
                pPreNode->pNextNode=pNodeAuxiliar->pNextNode;
                free(pNodeAuxiliar);
                this->size--;
                returnAux=0;
            }
...
int ll_containsAll(LinkedList* this,LinkedList* this2)
{
    ...
    if(this!=NULL && this2!=NULL)
    {
        ...
        for(i=0;i<ll_len(this2);i++)
        {
            ...
            returnAux=ll_contains(this,pNodeAux->pElement);
            if(returnAux==0)
            {
                break;
            }
...
LinkedList* ll_subList(LinkedList* this,int from,int to)
{
    int i;
    Node* auxNode;
    LinkedList* auxArray=NULL;

    if(this!=NULL)
    {
        if(to<=ll_len(this)&&from<to&&from<ll_len(this)&&from>=0)
        {
            auxArray=ll_newLinkedList();
            for(i=from;i<to;i++)
            {
               auxNode=getNode(this,i);
               addNode(auxArray,ll_len(auxArray),auxNode->pElement);
            }
        }
    }
    return auxArray;
...
LinkedList* ll_clone(LinkedList* this)
{
    ...
    if(this!=NULL)
    {
        auxArray=ll_subList(this,0,ll_len(this));
    }
    return auxArray;
}
